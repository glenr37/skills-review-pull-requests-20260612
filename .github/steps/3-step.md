...
1. Enter the following comment and click the **Submit review** button.
   ...
   <img width="300" alt="Submit review button" src="https://github.com/glenr37/skills-review-pull-requests-20260612/blob/main/.github/images/submit-review-button.png?raw=true" />
